...
- The authoritative design for the currently active feature is under `artifacts/product-publication-lifecycle/`: Phase 1 in `core-domain/specification.md` plus its Mermaid diagrams, and Phase 2 in `application-integration/specification.md`. Cross-feature system design lives in `docs/md/` (`02_system_architecture.md` for the service/data topology, `05_transactions_and_state.md` for transactional and state-machine behavior, `07_testing_plan.md`, `09_api_endpoint_delivery_process.md`, etc.).
